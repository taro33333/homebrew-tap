class CmdKeeper < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/taro33333/cmd-keeper/releases/download/v0.1.0/cmd-keeper-darwin-arm64"
    ...
    on_intel do
      url "https://github.com/taro33333/cmd-keeper/releases/download/v0.1.0/cmd-keeper-darwin-amd64"
  ...
  on_linux do
    on_intel do
      url "https://github.com/taro33333/cmd-keeper/releases/download/v0.1.0/cmd-keeper-linux-amd64"
