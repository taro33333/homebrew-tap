class SmartSorter < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/taro33333/smart-sorter/releases/download/v0.1.4/smart-sorter-darwin-arm64"
    ...
    on_intel do
      url "https://github.com/taro33333/smart-sorter/releases/download/v0.1.4/smart-sorter-darwin-amd64"
  ...
  on_linux do
    on_intel do
      url "https://github.com/taro33333/smart-sorter/releases/download/v0.1.4/smart-sorter-linux-amd64"
